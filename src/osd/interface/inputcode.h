...
constexpr input_code GUNCODE_BUTTON9_INDEXED(int n) { return input_code(DEVICE_CLASS_LIGHTGUN, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_BUTTON9); }
constexpr input_code GUNCODE_BUTTON10_INDEXED(int n) { return input_code(DEVICE_CLASS_LIGHTGUN, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, ITEM_ID_BUTTON10); }
...
#define GUNCODE_BUTTON9 GUNCODE_BUTTON9_INDEXED(0)
#define GUNCODE_BUTTON10 GUNCODE_BUTTON10_INDEXED(0)
...
// libretro D-Pad
#define JOYCODE_Y_HATUP_INDEXED(n)    input_code(DEVICE_CLASS_JOYSTICK, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, static_cast<input_item_id>(ITEM_ID_HAT1UP+4*n))
#define JOYCODE_Y_HATDOWN_INDEXED(n)  input_code(DEVICE_CLASS_JOYSTICK, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, static_cast<input_item_id>(ITEM_ID_HAT1DOWN+4*n))
#define JOYCODE_X_HATLEFT_INDEXED(n)  input_code(DEVICE_CLASS_JOYSTICK, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, static_cast<input_item_id>(ITEM_ID_HAT1LEFT+4*n))
#define JOYCODE_X_HATRIGHT_INDEXED(n) input_code(DEVICE_CLASS_JOYSTICK, n, ITEM_CLASS_SWITCH, ITEM_MODIFIER_NONE, static_cast<input_item_id>(ITEM_ID_HAT1RIGHT+4*n))
