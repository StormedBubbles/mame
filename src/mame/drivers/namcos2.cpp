...
static INPUT_PORTS_START( luckywld )
	...
	PORT_START("AN5")		/* Steering Wheel */
	PORT_BIT( 0xff, 0x80, IPT_PADDLE ) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CODE(JOYCODE_X) PORT_CODE_INC(KEYCODE_RIGHT) PORT_CODE_DEC(KEYCODE_LEFT)
	PORT_START("AN6")		/* Brake pedal */
	PORT_BIT( 0xff, 0x00, IPT_PEDAL2 ) PORT_MINMAX(0x00,0x7f) PORT_SENSITIVITY(100) PORT_KEYDELTA(30) PORT_CODE_INC(KEYCODE_DOWN)
	PORT_START("AN7")		/* Accelerator pedal */
	PORT_BIT( 0xff, 0x00, IPT_PEDAL ) PORT_MINMAX(0x00,0x7f) PORT_SENSITIVITY(100) PORT_KEYDELTA(15) PORT_CODE_INC(KEYCODE_UP)
