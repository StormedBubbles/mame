...
static INPUT_PORTS_START( jpark )
	...
	PORT_START("mainpcb:ANALOG1")
	PORT_BIT( 0xff, 0x90, IPT_AD_STICK_X ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5) PORT_MINMAX(0x3f,0xc0)

	PORT_START("mainpcb:ANALOG2")
	PORT_BIT( 0xff, 0x80, IPT_AD_STICK_Y ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5)

	PORT_START("mainpcb:ANALOG3")
	PORT_BIT( 0xff, 0x70, IPT_AD_STICK_X ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5) PORT_PLAYER(2) PORT_MINMAX(0x3f,0xc0)
